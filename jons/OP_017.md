...
and D(v) have a slightly different central lotus flower, which con- tinued to be used in Class E.
...
else the product of an inexperienced die-engraver who made an inadvertant error.
...
# H - > E\{i) F(iii) (v) (ix) (xii) Number of Coins 95% Confj Ldence I for Weight Stan 5.084 4.512 4.441 4.572 4.758 4.627 4.345 4.103 4.204 4.105 4.002 \_ 5.220 4.560 4.529 4.708 4.834 4.699 4.639 4.219 4.306 4.294 4.170
...
1921 that a standard of /^rds silver to /^rd copper was aimed for which,
...
0.23 0.52 0.39 0.23 0.12 0.34 0.42 0.48 0.47 0.45 0.48 0.35 4.19 0.39 4.10 0.26 --- ***r *** Gaden Tanqkas weighed by C. Valdettaro
