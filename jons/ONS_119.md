[Original PDF](https://www.orientalnumismaticsociety.org/archive/ONS_119.pdf)
...
Annual Subscription South Asia: Mr. P. P. Kulkarni £6.00; - Fl. 25; FF 75;  $ 12. Regional Secretaries General: Mr.G. P. Hennequin,.
...
Ray is currently recovering from a heart-attack suffered earlier this year. We wish him a full and speedy recovery. a
...
public. G.H. Summaries in German of the papers given at last year's Tübingen meeting will be published in this and future news- letters.
...
4.  The collection of Islamic coins formed by the late Tony Webdale will be coming up for auction at Glendinings on Tuesday 10 October this year. Catalogues of the sale will be available three weeks prior to the auction from the auctioneers at 7 Blenheim Street, New Bond Street, London W1Y 9LD. Members should note that the collection contains many interesting coins from a very wide range of dynasties.
...
- MARKOW, A. Inventarny Katalog Musulmanskikh Monet, St. Petersburg, 1896, with supplements I, II, 111 and IV (this final supplement not noted by Mayer), 1082 pages. Cloth. Markow's inventory catalogue of Islamic coins belonging to the Hermitage in Leningrad, with its four supplements, is the only glimpse that most numismatists will ever be able to gain into this large and most important collection. In order to save expense, Markow prepared the catalogue in handwritten form using Cyrillic script, which is a modified version of the normal bookface, and which did not include legends in Arabic. The inventory is the only work of its kind in Russian, and is an important tool for those interested in examining the holdings of Russian museums. No. of copies: 100, each hand-numbered. Price £275, plus £5 postage & packing.
...
1.  Stephan Heidemann (Berlin): Ökonomie des Kleingeldes und Münzverrufungen in Nordsyrien zwischen 1150 und 1237 AD:

Herr Heidemann legte anhand der Kupferpragung Nordsyriens Probleme des Kleingeldes und der Münzverrufungen in der zangidischen und ayyubidischen Zeit (ca. 1150-1237 AD) dar. Die Kupferpragung Aleppos und Nordsyriens dieser Zeit ist ein Verbindungsglied zwischen der Praxis der Münzverrufungen der bildlichen Grosskupfermünzen in Nordmesopotamien und dem ausdifferenzierten System der mamlukischen Syriens. Eine Münzverrufung wird als eine Form der Marktsteuer für Geld-/ Münzbesitzer innerhalb von Märkten interpretiert. Diese Märkte kommen im islamisch-arabischen Orient in Form von raumlich konzentrierten Geschaftsbezirken, den ''Suq's', vor, die einer bestimmten staatlichen Kontrolle, der Marktaufsicht (''Hisba"), unterliegen. Bei einer Auswechselung von Kleinmünzen sind nicht die politisch und ökonomisch macht igen Besitzer grosser Vermögen betroffen, sondern vor allem Kleinhandler und die unteren Bevölkerungsschichten. Islamische Kupfermünzen sind von Anbeginn des islamischen Rechtes und des Münzwesens als Geldzeichen angesehen worden. Ihr Wert wurde allein durch gesetzliche Konventionen und die Autorität lokaler Institutionen festgelegt. (In Europa kam der Gedanke des Ersatzes von Kleingeld durch Geldzeichen erst im 16. bzw. 17. Jahrhundert auf). Die Angaben der Chroniken über Kupfermünzverrufungen in Syrien in dieser Epoche sind sparlich; sie erwahnen nur eine einzige in Damaskus. Grabungsberichte liegen größtenteils nur aus Nordmesopotamien und nicht aus Nordsyrien vor. Die Hauptquelle für das Kupfermünzwesen bildet deshalb die Untersuchung der Münzen selbst. Insgesamt 15000 syrische Kupfermünzen wurden auf Identitaten und Veranderungen der Typen in der aleppiner und in den benachbarten Münzstatten untersucht, ebenso die Überprägungen und deren Untertypen, sowie die zeitgenössischen Beischlage. Auf diese Weise konnten Münzverrufungen in Aleppo nachgewiesen werden. Aufgrund der Gleichheit der Münztypen wurde vermutet, dass der kontrollierte Münzumlauf der aleppiner Münzen auch das benachbarte Fürstentum Hamah umfasste, welches zeitweise unter der Herrschaft Aleppos stand. Aufgrund der Überprägungen von Münzen benachbarter Staaten ist für die Märkte Aleppos und Hamahs ein geschlossenes Kleingeldumlaufgebiet zu vermuten. Wie sich der Umlauf in den landlichen Gebieten, ausserhalb der kontrollierten Märkte zusammensetzte, lasst sich aufgrund der Untersuchung nicht sagen. Diese Umlaufverhältnisse spiegeln sich jedoch in gewisser Weise in den Ausgrabungberichten wieder. Die haufigen Funde aleppiner Kupfermünzen in Nordmesopotamien sind deswegen mehr im Zusammenhang mit den spezifisch regionalen Währungsverhältnissen zu sehen. Schliesst man sich der Marktsteuer-Theorie an, so waren in der untersuchten Periode die Münzverrufungen keine regelmäßige Steuer, da die Zwischenintervalle zwischen ca. 4und 18 Jahren betrugen. Die konkreten historischen Anlasse für die Münzverrufungen sind bisher noch unbekannt.
...
Table (3) shows the extremely rare drachms of Pallas left with *[monogram]* monograms for which I know of no tetradrachms nor copper issue of the Elephant/Bull type (unless it is perhaps those with *[monogram]*) though there are Bull/Lion and possibly small Elephant/Lion coppers indicating a possible later date for this issue than usual for the type.

<!-- OCR: two hand-drawn Kharosthi monogram glyphs in this sentence have no typable Unicode equivalent; the same monogram system is drawn out in full on the plate figure at md line ~112 below -->
<!-- script-deferred page=3 rect=40,547,555,583 reason=not real script -- these are hand-drawn ad-hoc monogram/control-mark symbols the numismatist uses to distinguish coin varieties, not Kharosthi letters conveying a word (rendered and inspected at 10x zoom); the same monogram system is drawn out in full as artwork on the plate figure at md line ~112 below -->
...
*[monogram]* *[monogram]* and particularly those with DOTs above right monogram) though the coins of the isolated Arachosian types in tables
<!-- script-deferred page=3 rect=40,745,555,785 reason=not real script -- two hand-drawn Greek-letter control monograms (a barred-A/Λ shape with a right-side arm, and an M-shape with a central stem topped by a small hook), the same kind of coin-variety monogram symbol used as row/column headers on the plate figure below, not Kharosthi/Arabic script conveying a word; confirmed via opus verification agent against a 10x zoom crop -->

5 and 6 are more problematic. The DOT privy marks are significant in dating these issues of Azes II as being early since they were in use by Azes I and Azilises towards the end of their respective rule and only appear on a few Azes II coins before being phased out. These DOT issues must therefore be placed at the beginning of the period.

*[figure]* <!-- figure page=5 rect=0,0,596,838 -- full-page hand-drawn plate accompanying the Pallas coinages article: seven ruled grid tables (Table 1 "PALLAS LEFT"/"PALLAS FACING" with RIGHTARM DOWN/UP sub-columns, Table 4 and 5 "PALLAS LEFT"/"PALLAS RIGHT", Table 6, Table 7) with hand-drawn Kharosthi/monogram glyph row and column headers, cells marked with a legend "TABLE 1 ●=TETRADR. ▲=DRACHM"; plus about 13 numbered coin-facsimile drawings (1a, 1b, Copper 1, 2a, 2b, 3, 4, Copper 4 x2, 5, 6, 7a, 7b) labelled OBVERSE, each with Greek legends around the rims -->

The Imperial Chinese Specimen Coins, Advertising Pieces, Medals and Medallions Struck at The Birmingham Mint
...
- Kann, Illustrated Catalog of Chinese Coins, USA 1966, p.285.
...
Thanks are due to Mr Colin Perry, Managing Director of The Birmingham Mint Group plc., and to Mrs. A. Meredith, Deputy Keeper, Department of Local History, Birmingham City Council Museums and Art Gallery, for help and information; and to Mr G. Charman, Format, for the loan of a coin (H.2).
