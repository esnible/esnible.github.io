[Original PDF](https://www.orientalnumismaticsociety.org/archive/IS_005.pdf)
...
<!-- script-deferred page=12 reason=raw OCR noise from the already table-deferred geographical distribution table (see the table-deferred marker further below covering the whole table); this stretch had four separate fragments pdfmd misparsed as headings ("## Ze", "##,", a bare "# " line, and "# L370(1). 370(1"), spanning roughly the AH 344-355 column band; none are standalone legends -- to continue, render PDF p.12 at high DPI and re-transcribe this band directly from the image -->
