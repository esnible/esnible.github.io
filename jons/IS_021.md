...
In view of the previous remarks, No. 22 requires no further explanation except to draw attention to the fact that the arms display the opposite order to those on No. 20, while the decoration to the left and right of the shield is almost the same as shown on No. 21. Plate II, 23 and 23a. Plate VII. C.
