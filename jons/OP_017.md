[Original PDF](https://www.orientalnumismaticsociety.org/archive/OP_017.pdf)
...
but the main differences between the classes may be summarised as follows:-

<!-- summary table with no ruled borders, PDF pages 0-1; rows A-F on page 0, G-H on page 1.
     The "outer angles" cells hold small hand-drawn symbols (dot clusters, wavy
     lines); they are described here in words and read together with the fuller
     "Symbols in outer angles of petals" lines under each class in Appendix I. -->

| Class | Obv. outer angles | Obv. waterline below lotus | Rev. outer angles | Rev. centre circle | Weight |
|:--- |:--- |:--- |:--- |:--- |:--- |
| A | 3 dots | None | wavy line | Pellet | c 5.1 grm |
| B | 3 dots | 2 lines | wavy line | 3 Crescents | c 4.5 grm |
| C | 3 dots | 1 line | wavy line | 2 Crescents | c 4.5 grm |
| D | 3 dots | 1 line | 3 dots | 2 Crescents | c 4.7 grm |
| E | wavy line | 1 line | 3 dots | 2 Crescents | c 4.7 grm |
| F | 1 dot | 1 line | 3 dots | 2 Crescents | c 4.7 grm reducing to c 4.2 grm |
| G | None | 1 line | None | 2 Crescents | c 4.2 grm |
| H | 1 dot | 1 line | 1 dot | 3 Crescents | c 4.1 grm |
...
at 5 1/3 annas. Hence, between 1879 and 1881 the Gaden Tangka had
...
taken, and surviving specimens seem to be a fairly random sample of those pieces that were struck.
...
- **Rev:** eight petalled flower within star surrounded by inscription broken up into eight oval frames. Inscription in Tibetan reading "Ga-den Pho-dang chhog-le rnam-gyal" = The Gaden Palace victorious on all sides.

<!-- Appendix I is a run of per-class catalogue entries. Each class heading is
     followed by its date and mint, a prose description, and (for Classes B, D,
     E, F, H) a hand-drawn chart plotting the lucky-sign glyph used at each of
     the eight compass points (N NE E SE S SW W NW) for every variety. Those
     glyphs are hand lettering and cannot be transcribed; each chart is kept as
     a figure placeholder and the typed variety labels + trailing style notes
     are carried across in a Variety / Notes table. Hand-drawn Tibetan
     petal syllables in the notes are read as "rnam" (a best guess, consistent
     with the main text's discussion of the rnam petal). -->
...
Numerous minor varieties in lucky signs, especially in conch shell (W). Fishes (NE) are drawn one way on (i), and one of two other ways on (ii).
...
*[figure]* <!-- figure page=10 -- hand-drawn chart, PDF pages 10-11: lucky-sign glyphs at the S, SW, W and NW points for Class B varieties (i), (ii), (iii), (iiia), (iv), (iva), (ivb) -->

| Variety | Notes |
|:--- |:--- |
| (i) | Plain arch to l. of the *rnam* petal on rev. |
| (ii) | Plain arch to l. of the *rnam* petal on rev. |
| (iii) | — |
| (iiia) | — |
| (iv) | No secret marks. |
| (iva) | — |
...
Types (i) and (ii) have dot to l. and crescent to r. of lotus. Fishes (NE) always take one form on (i), but either of two other forms on other types. On (iii), a small line joins the petal containing *rnam* to the concave octagon on rev.

### Class C

*Circa 1895-6. Dod-pal Mint?*

Single water-line below lotus flower. Two crescents in centre of reverse. These two features now remain unchanged for all future types. Order of lucky signs is changed, so that conch-shell is now S instead of W. Style of lotus flower changed, with 3 small leaves to l. and r.

Symbols in outer angles of petals: 3 dots (lotus side), wavy line (inscription side).
...
Symbols in outer angles of petals: 3 dots (lotus side), 3 dots (inscription side). Otherwise styles as Type C, except that the lotus in Type D(iv) is similar to that used in Type E.

*[figure]* <!-- figure page=11 -- hand-drawn chart, PDF page 11: lucky-sign glyphs at the eight compass points for Class D varieties (i)-(v) -->
...
Symbols in outer angles of petals: wavy line (lotus side), 3 dots (inscription side).

*[figure]* <!-- figure page=11 -- hand-drawn chart, PDF page 11: lucky-sign glyphs at the eight compass points for Class E varieties (i)-(vii) -->
...
| (iv) | — |
| (v) | As (iv), but style differs and small circle around lotus — diam. 7.5 mm. |
| (vi) | — |
| (vii) | — |

All varieties have spokes. E(v) is the only variety not to have dots left and right of the central lotus (see main text). A variety of E(iv) has 6 leaves issuing from water at base of lotus, instead of the usual 4.

### Class F

*Circa 1907-1922, 1924-5. Do-de Mint.*

Symbols in outer angles of petals: 1 dot (lotus side), 3 dots (inscription side).

*[figure]* <!-- figure page=12 -- hand-drawn chart, PDF pages 12-13: lucky-sign glyphs at the eight compass points for the Class F varieties, grouped by period (1907-12, 1912-18, 1918-22, 1924-5); a small marginal sketch shows the "solid buds" / "hollow buds" difference -->
...
| (iv) | — |
| (v) | — |
| (vi) | Circle diam. c 12 mm * |
| **1912-18** | |
| (vii) | Circle diam. c 11 mm * |
| (viii) | Dots l. & r. of lotus. |
| (viiia) | No dots. |
| (ix) | — |
| **1918-22** | |
| (x) | Cruder style. |
...
Varieties (iia) and (iiia) are mules between (ii) and (iii). (iiib) has an obv. die altered from (ii). There is a rev. die-link between (iv) and (v). Varieties (vii), (viii) and (ix) are in fine style. There are numerous varieties of style in (x) and (xi), including small or large pellets in outer border etc. (xii) has pellets to left and right of base of lotus, in water-line.

### Class G

*Circa 1921. Ser-khang Mint.*

No symbols in outer angles. Petals on obv. joined. Fine style. No spokes or dots by lotus. Rev. reads *rnam*. No varieties in lucky signs.
...
*[figure]* <!-- figure page=13 -- hand-drawn chart, PDF page 13: the conch-shell glyph at S distinguishing Class H varieties (i) and (ii) -->
...
The results of this analysis are summarised below based on both my own data and the Valdettaro data:-

| Date | Class | Number of Coins | 95% Confidence Interval for Weight Standard * |
|:--- |:--- |:--- |:--- |
| c.1840s | A | 25 | 5.084 - 5.220 |
| c.1880-94 | B | 654 | 4.512 - 4.560 |
| c.1895-96 | C | 128 | 4.441 - 4.529 |
| c.1896-97 | D(i) | 55 | 4.572 - 4.708 |
| c.1897-1901 | D(ii) - E(i) | 231 | 4.758 - 4.834 |
| c.1901-09 | E(ii) - F(iii) | 483 | 4.627 - 4.699 |
| c.1910-12 | F(iv) - (v) | 31 | 4.345 - 4.639 |
| c.1912-18 | F(vi) - (ix) | 281 | 4.103 - 4.219 |
| c.1918-25 | F(x) - (xii) | 275 | 4.204 - 4.306 |
| c.1921 | G | 70 | 4.105 - 4.294 |
| c.1929-30 | H | 29 | 4.002 - 4.170 |
...
<!-- landscape table, PDF page 16 (unpaginated). The body of the page is a
     hand-typed histogram: for each variety, the count of specimens in each
     0.1 g weight bin from 2.8 g to 6.0 g (the column headings are printed only
     every 0.2 g). Those histogram cells are typed without ruling and their
     digits touch; they are not transcribed here. The Total, Average weight and
     standard-deviation columns are reproduced in full below -- the Totals sum
     to the 1637 coins stated in the Appendix II text. See PDF page 16 for the
     per-bin distribution. -->

*[figure]* <!-- figure page=16 -- hand-typed weight-distribution histogram: specimen counts by 0.1 g bin (2.8-6.0 g) for each variety A(i) to H -->

| Variety | Total | Average weight | Standard deviation |
|:--- |:--- |:--- |:--- |
| A(i) | 17 | 5.15 | 0.17 |
| A(ii) | 8 | 5.16 | 0.13 |
| B(i) | 25 | 4.49 | 0.31 |
...
## Gaden Tangkas weighed by C. Valdettaro

<!-- table with no ruled borders, PDF page 17. A blank cell means the figure is not given
     on the page (a "-" is printed where a whole row has no data). -->

| Class | Total Number | Average weight | Highest weight | Lowest weight |
|:--- |:--- |:--- |:--- |:--- |
| A(i) | - | - | - | - |
| A(ii) | - | - | - | - |
| B(i) | 25 | 4.37 | | |
| B(ii) & B(iii) | 160 | 4.55 | 5.2 | 3.6 |
| B(iv) | 116 | 4.54 | 5.2 | 3.65 |
| C | 38 | 4.47 | 4.9 | 3.85 |
| D(i) | 23 | 4.60 | 5.15 | 4.1 |
| D(ii) | 17 | 4.83 | 5.4 | 4.35 |
| D(iii) | 21 | 4.73 | 5.15 | 4.1 |
| D(iv) | 23 | 4.65 | 5.3 | 3.5 |
| D(v) | - | - | - | - |
| E(i) | 22 | 4.86 | 5.6 | 4.15 |
| E(ii) | 13 | 4.67 | 5.05 | 4.15 |
| E(iii) | 35 | 4.66 | 5.3 | 4.0 |
| E(iv) | 34 | 4.70 | 5.4 | 3.85 |
| E(v) | - | - | - | - |
| E(vi) | 28 | 4.53 | 5.45 | 3.95 |
| E(vii) | 3 | 5.15 | 5.25 | 5.0 |
| F(i) | 7 | 4.84 | | |
| F(ii) | 29 | 4.65 | 5.05 | 4.1 |
| F(iii) | 17 | 4.58 | 5.75 | 3.15 |
| F(iv) | 10 | 4.42 | | |
| F(v) | 1 | 4.25 | | |
| F(vi) & F(vii) | 111 | 4.23 | 6.4 | 2.9 |
| F(viii) & F(x) | 237 | 4.25 | 5.4 | 3.05 |
| F(ix) & F(xi) | 113 | 4.19 | 5.2 | 2.65 |
| F(xii) | 14 | 4.31 | 4.9 | 3.55 |
| G | 24 | 4.22 | 5.0 | 3.5 |
| H | 3 | 4.0 | | |

For some varieties the highest and lowest weights were not calculated.

In some instances, the classification of varieties used did not coincide with the system used in this paper, so combined results have had to be given. In cases where the two varieties may have been struck to different weight standards, the above results have had to be ignored in the main analysis of weight standards.
...
4. H A Jaeschke, 1881, *Tibetan-English Dictionary*, p.281.
5. F Kempf, 1969, *Native Tibetan Coins*.
...
8. I S Rawat, 1973, *Indian Explorers of The Nineteenth Century*, p.92.
...
*[figure]* <!-- figure page=19 -- plate of ten hand-drawn obverse/reverse coin facsimiles, one pair per specimen, labelled A(ii), B(iii), C, D(v), E(v), E(vi), F(iii), F(xi), G, H -->
