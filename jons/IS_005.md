...
<!-- script-deferred page=12 reason=raw OCR noise from the already table-deferred geographical distribution table (see the table-deferred marker further below covering the whole table); falls in roughly the AH 344-347 column band; not a standalone legend -- to continue, render PDF p.12 at high DPI and re-transcribe this band directly from the image -->

##,

<!-- script-deferred page=12 reason=raw OCR noise from the already table-deferred geographical distribution table (see the table-deferred marker further below covering the whole table); falls in roughly the AH 352-355 column band; not a standalone legend -- to continue, render PDF p.12 at high DPI and re-transcribe this band directly from the image -->

<!-- script-deferred page=12 reason=raw OCR noise from the already table-deferred geographical distribution table (see the table-deferred marker further below covering the whole table); pdfmd misparsed this fragment as a heading (leading "# "); not a standalone legend -- to continue, render PDF p.12 at high DPI and re-transcribe this band directly from the image -->
...
<!-- script-deferred page=12 reason=caption/footnote of the already table-deferred geographical distribution table above; legible English survives mixed with residual glyph noise ("Distribution of multiple dirhems cross-hatched. FARWAN -- only two Ghaznavid issues cited, coins are common but dates often off flan...") -- to continue, render PDF p.12 at high DPI and re-transcribe the caption cleanly by hand from the image; it is not part of the untranscribable data grid itself -->
