...
<!-- OCR: two-line hand-lettered Arabic marginal legend running around the coin's edge, PDF p.4 -- not transcribed here (cursive hand, needs transcribe-foreign-script); per the article's own note the legends of both faces are the same, and the second line is expected to read close to "ضرب هذا الدرهم ترمذ سنة ست عشر وستمائة" (struck, this dirham, Tirmidh, year six hundred and sixteen), matching the mint and AH date given above -->
